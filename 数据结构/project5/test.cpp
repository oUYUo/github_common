...
void CreateTree(float* table,queue<int> QNode,float* arr)
{
 ...
 int main(){
	...
	QNode.push(1);
	CreateTree(table,QNode,G.edge);
//	QNode.push(4);
//	QNode.push(2);
//	

//	setTableElement(table,4,3,1);
//	setTableElement(table,4,1,1);
//	setTableElement(table,4,2,0.3);
//	setTableElement(table,2,3,1);
//	setTableElement(table,2,2,0.3);
//	setTableElement(table,2,1,1);


//
//	float* NodeValue=Search_Min_Node(QNode,G.edge,table);
//	sendValue(table,NodeValue);
//	QNode.push(NodeValue[1]);
//	cout<<QNode.back()<<endl;
//	NodeValue=Search_Min_Node(QNode,G.edge,table);
//	sendValue(table,NodeValue);
//	printTable(table);
//	cout<<isAllVisited(table); 
////	sendValue(table,Search_Min_Node(QNode,G.edge,table));
////	cout<<endl;
////	printTable(table);
